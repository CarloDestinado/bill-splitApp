  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errors) {
        ...
        setError(err.response?.data?.message || 'Failed to send reset token. Please check your details.');
      }
    } finally {
      setLoading(false);
    }
    ...
    <div className="forgotpass-page">
      <div className="forgotpass-container">
        ...
        <div className="forgotpass-right">
          ...
          <p className="subtitle">Enter your nickname and email to reset your password</p>
